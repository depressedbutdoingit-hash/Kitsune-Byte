...
class AITimeTravelScreen extends StatefulWidget {
  ...
  const AITimeTravelScreen({super.key, required this.projectId});

  @override
  State<AITimeTravelScreen> createState() => _AITimeTravelScreenState();
}
...
class _AITimeTravelScreenState extends State<AITimeTravelScreen> {
  ...
  Future<void> _activateBranch(String branchId) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Restored to this branch')),
    );
  }
